            ...
            <div className="mx-auto max-w-[896px] min-h-screen bg-[var(--bg-primary)] shadow-sm">
              <div className="flex min-h-screen flex-col justify-between">
                ...
                <div className="w-full px-4 md:px-6">
                  <footer className="flex flex-col sm:flex-row items-center justify-between w-full py-6 border-t border-[var(--border-primary)] gap-3 sm:gap-0">
                    ...
                    <div className="flex items-center justify-center gap-2 sm:gap-3">
                      ...
                      <span className="text-[var(--text-muted)] text-[8px] sm:text-xs font-normal leading-5 text-center sm:text-left">
                    ...
                    <div className="flex items-center justify-center gap-2 text-[var(--text-muted)] text-[8px] sm:text-xs font-normal leading-5 mt-1 sm:mt-0">
