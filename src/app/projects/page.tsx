...
export default function Projects() {
  return (
    <div className="w-full flex flex-col gap-12 px-6 py-8 border-x border-[var(--border-primary)] min-h-full">

      <div className="w-full mt-2">
        <h1 className="text-sm sm:text-[13px] font-bold text-[var(--text-primary)] uppercase tracking-wide leading-relaxed w-full">
      ...
      <section className="flex flex-col w-full pt-6 border-t border-[var(--border-secondary)] mb-8">
        <div className="flex items-center gap-2 mb-6">
          <FaGithub size={16} className="text-[var(--text-primary)]" />
          <h2 className="text-sm font-bold text-[var(--text-primary)] uppercase tracking-wider">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
          {REPOSITORIES.map((repo, idx) => (
            <a
              ...
              className="block h-full hover:-translate-y-1.5 transition-transform duration-300 outline-none"
            >
